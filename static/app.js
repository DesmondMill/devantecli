// ============================================
// Devante CLI UI — Main Application Orchestrator
...
function startOdysseusApp() {
  ...
  const _userBarAdmin = el('user-bar-admin');
  const openAdminSettings = () => {
    // Open settings modal and switch to services tab (admin endpoints)
  ...
  if (_railAdmin) {
    _railAdmin.addEventListener('click', openAdminSettings);
  }
  if (_userBarAdmin) {
    _userBarAdmin.addEventListener('click', openAdminSettings);
  }
