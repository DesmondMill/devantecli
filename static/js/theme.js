...
export const THEMES = {
  dark:       { bg:'#050712', fg:'#f9fafb', panel:'#0b0f1c', border:'#151a2a', red:'#f97316' },
...
const LS_KEY = 'devante-cli-theme';
const CUSTOM_THEMES_KEY = 'devante-cli-custom-themes';
...
const ADV_KEYS = [
  ...
  { key: 'brandColor',         css: '--brand-color',       label: 'Devante CLI Logo',    group: 'Sidebar' },
...
export function initThemeUI() {
  ...
  if (exportBtnEl) {
    ...
    newExp.addEventListener('click', () => {
      ...
      a.href = url;
      a.download = 'devante-cli_' + (obj.name || 'theme') + '.json';
      a.click();
